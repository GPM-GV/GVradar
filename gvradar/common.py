...
# Get date/time, site, and scan type from radar.  Retrieve universal field names.
    ...
    if site == b'ST1\x00\x00\x00\x00\x00' or b'ST1-P\x00\x00\x00' or site == 'ST1-P': site = 'ST1'
    if site == b'SV1\x00\x00\x00\x00\x00' or b'SV1-P\x00\x00\x00' or site == 'SV1-P': site = 'SV1'
